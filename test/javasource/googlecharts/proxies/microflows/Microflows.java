...
public class Microflows
{
	...
	public static void iVK_UpdateSankeyResult(IContext context, googlecharts.proxies.Result _result)
	{
		try
		{
			Map<java.lang.String, Object> params = new HashMap<java.lang.String, Object>();
			params.put("Result", _result == null ? null : _result.getMendixObject());
			Core.execute(context, "GoogleCharts.IVK_UpdateSankeyResult", params);
		}
		catch (CoreException e)
		{
			throw new MendixRuntimeException(e);
