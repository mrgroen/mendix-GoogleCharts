...
/*
    ...
    Documentation
    ========================
    A bar chart is a horizontal chart rendered in the browser using SVG or VML, whichever is appropriate for the user's browser. Like all Google charts, bar charts display tooltips when the user hovers over the data. For a vertical version of this chart, see the column chart.
...
define([
    ...
    return declare('GoogleCharts.widget.GoogleBarChart', [_WidgetBase, _TemplatedMixin], {
...
require(['GoogleCharts/widget/GoogleBarChart'], function () {
    'use strict';
});
